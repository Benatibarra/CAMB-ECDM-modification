...
def set_params_cosmomc(p, num_massive_neutrinos=1, neutrino_hierarchy='degenerate', halofit_version='mead',
    ...
    pars.set_dark_energy(w=p.get('w', -1), wa=p.get('wa', 0), eta= p.get('eta', 5), eta_xd=p.get('z_dagger',6),  dark_energy_model=dark_energy_model) # Beñat Modification, just 5*ln(1+2.33)=6 give or take
